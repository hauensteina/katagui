...
def donation_blurb( mobile):
    ...
    DONATED += 20+20+5+20+10+5+25+130+20+15+10+20
    LIMIT = 2000
    frac = DONATED / LIMIT
    pct = round( 100 * frac)
    restpct = str(100 - pct) + '%'
...
_kor = {
    ...
    ,'dollars':'달러'
    # Donation
    ,'donation_blurb': '카타고 운영을 위해 전용 서버를 구축하려면 총 #AMOUNT 달러 정도의 비용이 소모됩니다. 목표 달성까지 #REST가 남았습니다! 카타고 운영을 위해 후원을 고려해주세요. 20달러 이상 후원시 캘리포니아에 방문하면 맥주 한 잔을 사드립니다.'
...
# Top Bar
    ...
    ,'Fast (20 blocks)':'早い(20 blocks)'
    ,'Strong (40 blocks)':'強い(40 blocks)'
    # Login and Registration
    ,'Guest':'ゲスト'
    ,'Please Log In':'ログインしてください'
    ,'Email':'Eメール'
    ,'Password':'パスワード'
    ,'Request Password Reset':'パスワードのリセットを申請する'
    ,'Password':'パスワード'
    ...
    ,'KataGo resigns.':'KataGoが投了しました'
    ,'KataGo passes. Click on the Score button.':'KataGoがパスしました。形勢ボタンを押してください'
    ,'KataGo is thinking ...':'KataGoが検討中です'
    ,'KataGo is counting ...':'KataGoが計算中です'
    ,'dollars':'ドル'
    # Donation
    ,'donation_blurb': 'KataGoを維持運営して行くには、専用のサーバーが必要です。それに掛かる費用は#AMOUNTドルです。あと#REST不足しています。寄付をお願いします。20ドル以上、ご協力いただけた方には、カリフォルニアにおいでの際に、ビールを一杯ごちそうします。'
    ,'donation_status':'現状（毎日更新）：'
    ,'Top Three Donors':'寄付金トップ3'
    # Registration dance
    ,'visit_link_activate':'登録を有効にするためにリンクをクリックしてください'
    ,'register_ignore':'登録を無視する'
    ,'visit_link_password':'リンクを押してパスワードを更新'
    ,'password_ignore':'パスワードを無視する'
    ,'not_verified':'確認できませんでした'
    ,'login_failed':'ログインに失敗しました'
    ,'account_exists':'そのアカウント名は既に存在しています'
    ,'guest_invalid':'そのゲスト名は無効です'
    ,'name_taken':'その名前は既に取得されています'
    ,'err_create_user':'ユーザー作成エラー'
    ,'email_sent':'Eメールが送られました'
    ,'email_verified':'Eメールが確認されました'
    ,'email_not_exists':'Eメールが存在しません'
    ,'reset_email_sent':'リセットのEメールが送られました'
    ,'password_updated':'パスワードが更新されました'
    ,'account_updated':'アカウントが更新されました'
    ,'invalid_token':'無効な識別子です'
    ,'W':'白'
    ,'B':'黒'
    ,'Result':'結果'
    ,'Date':'日付'
