...
def donation_blurb( mobile):
    ...
    Used in Jinja templates.
    '''
    DONATED = 55+26+15+5+21+10+50+10+20+21+5+10+21+30+5+5+25+10+100+20+19+29+21+20+20+31+20+20+10+120
    LIMIT = 2000
    frac = DONATED / LIMIT
    pct = round( 100 * frac)
    restpct = str(100 - pct) + '%'
...
_kor = {
    ...
    ,'Fast (20 blocks)':'빠름 (20 블럭)'
    ,'Strong (40 blocks)':'강함 (40 블럭)'
    ...
    ,'Show probability during play':'플레이 중 착수 가능성 보이기'
    ,'Save':'저장'
    ,'P(B wins)':'P(흑 기준)'
    ,'KataGo resigns. You beat Katago!':'카타고가 불계를 선언했습니다. 카타고에계 승리했습니다!'
    ,'KataGo resigns.':'카타고가 불계를 선언했습니다.'
    ,'KataGo passes. Click on the Score button.':'카타고가 한수 쉬었습니다. 형세판단(계가) 버튼을 눌러주세요.'
    ,'KataGo is thinking ...':'카타고가 생각 중입니다.'
    ,'KataGo is counting ...':'카타고가 계가 중입니다.'
    ,'dollars':'달러'
    # Donation
    ...
    ,'password_updated':'새로운 비밀번호가 저장되었습니다. 로그인 할 수 있습니다.'
