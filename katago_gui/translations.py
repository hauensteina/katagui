...
def donation_blurb( mobile):
    ...
    Used in Jinja templates.
    '''
    DONATED = 55+26+15+5+21+10+50+10+20+21+5+10+21+30+5+5+25+10+100+20+19+29
    LIMIT = 2000
    frac = DONATED / LIMIT
    pct = round( 100 * frac)
    restpct = str(100 - pct) + '%'
...
_eng = {
    ...
    ,'password_ignore':'If you did not make this request then simply ignore this email and no changes will be made.'
    ...
    ,'email_sent':'An email has been sent to verify your address. Make sure to check your Spam folder.'
    ,'email_verified':'Your email has been verified! You are now able to log in.'
    ...
    ,'password_updated':'Your password has been updated! You are now able to log in'
